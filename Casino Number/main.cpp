...
int main(){
    ...
    system ("Color 5F"); //CLI color changer
    ...
    cout << "==============================" << std::endl;
    cout << "To Start, please enter your card" << std::endl;
    ...
    cout << "==============================\n\n";
    cout << "WELCOME TO VIRTUAL BACCARAT TABLE" << std::endl;
    cout << "=================================" << std::endl;

    do{ //main do-while loop

        cout << "Current balance, PHP " << money << std::endl;
        cout << "1-BANKER \n2- PLAYER \n";
